...
package com.pseudozach.bitalarm.alarms.background;
...
import static com.pseudozach.bitalarm.util.Preconditions.checkNotNull;
...
public class PendingAlarmScheduler extends BroadcastReceiver {
    ...
    public static final String EXTRA_ALARM_ID = "com.pseudozach.bitalarm.alarms.background.PendingAlarmScheduler.extra.ALARM_ID";

...
import com.pseudozach.bitalarm.data.ObjectWithId;
...
public abstract class Alarm extends ObjectWithId implements Parcelable {
    ...
    public void copyMutableFieldsTo(Alarm target) {
        ...
        target.snoozedDuration = this.snoozedDuration;
    }
    ...
    public void setSnoozedDuration(long snoozedDuration){
        Log.e("A", "setting snoozed duration: " + String.valueOf(snoozedDuration));
        this.snoozedDuration = snoozedDuration;
    }

    public long getSnoozedDuration(){
        return snoozedDuration;
    }
}

 ...
 */
public class AlarmCountup extends TextView {
    private static final String TAG = "AlarmCountup";
    ...
    public interface OnChronometerTickListener {
         ...
         */
        void onChronometerTick(AlarmCountup chronometer);
     ...
     */
    public AlarmCountup(Context context) {
        this(context, null, 0);
    }
     ...
     * Sets the base to the current time.
     */
    public AlarmCountup(Context context, AttributeSet attrs) {
     ...
     * Sets the base to the current time.
     */
    public AlarmCountup(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        a.recycle();
    ...
    @TargetApi(21)
    public AlarmCountup(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        String text = DateUtils.formatElapsedTime(mRecycle, seconds);
        Log.e("ACUP now", String.valueOf(now));
        Log.e("ACUP mBase", String.valueOf(mBase));
        Log.e("ACUP millis", String.valueOf(millis));

        String text = DurationUtils.toString(getContext(), millis, false/*abbreviate labels*/);
        text = String.valueOf(millis);

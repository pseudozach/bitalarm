...
import com.pseudozach.bitalarm.InvoiceActivity;
...
import com.pseudozach.bitalarm.alarms.data.AlarmCursor;
import com.pseudozach.bitalarm.alarms.data.AlarmsListCursorLoader;
import com.pseudozach.bitalarm.alarms.data.AsyncAlarmsTableUpdateHandler;
...
import com.pseudozach.bitalarm.util.DelayedSnackbarHandler;

import static com.pseudozach.bitalarm.util.FragmentTagUtils.makeTag;

public class WalletFragment extends RecyclerViewFragment<Alarm, BaseAlarmViewHolder, AlarmCursor,
        AlarmsCursorAdapter> implements BottomSheetTimePickerDialog.OnTimeSetListener {
    private static final String TAG = "WalletFragment";
    private static final String KEY_EXPANDED_POSITION = "expanded_position";
    public static final String EXTRA_SCROLL_TO_ALARM_ID = "com.pseudozach.bitalarm.alarms.extra.SCROLL_TO_ALARM_ID";
...
// Set up the buttons
    ...
    protected int emptyMessage() {
        return R.string.empty_wallet_container;
    }

    @Override
    protected int emptyIcon() {
        return R.drawable.ic_account_balance_wallet_white_96dp;
    }
    ...
    private static String makeTimePickerDialogTag() {
        return makeTag(WalletFragment.class, R.id.fab);
    }

...
package com.pseudozach.bitalarm.timers;
...
public class TimerNotificationService extends ChronometerNotificationService {
    ...
    private static final String ACTION_CANCEL_NOTIFICATION = "com.pseudozach.bitalarm.timers.action.CANCEL_NOTIFICATION";
    public static final String ACTION_ADD_ONE_MINUTE = "com.pseudozach.bitalarm.timers.action.ADD_ONE_MINUTE";

    public static final String EXTRA_TIMER = "com.pseudozach.bitalarm.timers.extra.TIMER";
    private static final String EXTRA_CANCEL_TIMER_ID = "com.pseudozach.bitalarm.timers.extra.CANCEL_TIMER_ID";

...
public abstract class ChronometerNotificationService extends Service {
    public static final String ACTION_START_PAUSE = "com.pseudozach.bitalarm.timers.action.START_PAUSE";
    public static final String ACTION_STOP = "com.pseudozach.bitalarm.timers.action.STOP";

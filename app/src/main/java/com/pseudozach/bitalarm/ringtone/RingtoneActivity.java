...
import com.pseudozach.bitalarm.util.LocalBroadcastHelper;
...
public abstract class RingtoneActivity<T extends Parcelable> extends BaseActivity {
    ...
    public static final String ACTION_FINISH = "com.pseudozach.bitalarm.ringtone.action.FINISH";
    public static final String EXTRA_RINGING_OBJECT = "com.pseudozach.bitalarm.ringtone.extra.RINGING_OBJECT";
    public static final String ACTION_SHOW_SILENCED = "com.pseudozach.bitalarm.ringtone.action.SHOW_SILENCED";

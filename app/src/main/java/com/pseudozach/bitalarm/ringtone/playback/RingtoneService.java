...
import com.pseudozach.bitalarm.ringtone.RingtoneActivity;
...
public abstract class RingtoneService<T extends Parcelable> extends Service {
    ...
    // public okay
    public static final String ACTION_NOTIFY_MISSED = "com.pseudozach.bitalarm.ringtone.action.NOTIFY_MISSED";
